...
public class OpcUaClient
{
    ...
    public OpcUaClient()
    {
        ...
        var configuration = new ApplicationConfiguration
        {
            ...
            {
                AutoAcceptUntrustedCertificates = true,//值指示是否应自动接受不受信任的证书
                RejectSHA1SignedCertificates = false,//该值指示是否接受SHA-1签名证书
                MinimumCertificateKeySize = 1024,//该值指示接受哪个最低证书密钥强度
                SuppressNonceValidationErrors = true,//该值指示是否应抑制服务器nonce验证错误
